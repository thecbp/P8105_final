...
For this sub-analysis we wanted to see how colectomy successes were correlated with insurance staus. We chose to measure success with the number of SSIs, involving the variables postop_ssi_super, postop_ssi_deep, and postop_ssi_organspace.
